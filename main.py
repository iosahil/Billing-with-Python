...
try:
    resp = client.messages.create(body="Welcome to Sahil's program, " +
                                  name.capitalize(),
                                  from_='+13126754624',
                                  to=sendto)
except:
...
rate = [['Gold', '500ml', 26.18], ['Gold', '1L', 51.35],
        ['Shakti', '500ml', 23.20], ['Shakti', '1L', 45.40],
        ['Cow', '500ml', 22.20], ['Cow', '1L', 43.40],
        ['Taaza', '500ml', 21.18], ['Taaza', '1L', 41.40],
        ['Amul Kool (Plastic)', '200ml * 30', 540.00], ['Dahi', '200g', 13.86],
        ['Dahi', '400g', 24.63], ['Dahi', '1KG', 56.80],
        ['Lassi (Packet)', '180ml', 9.10], ['Paneer', '200g', 66.00],
        ['Paneer', '1KG', 315.00]]  # Rate of products
...
if (ans1.upper() == "Y") or (ans1 == "1"):
    print(
        tabulate(rate,
                 headers=[
                     Color.BOLD + "Item", "Quantity",
                     "Selling Price" + Color.END
                 ],
                 numalign="left"))
...
if (ans2.upper() == "Y") or (ans2 == "1"):
    ...
    for i in progressbar(range(10), desc='Opening...', ascii=False, ncols=75):
        time.sleep(0.25)
    print("Complete.\n")

    # Let's create art
    banner = art.figlet_format("WELCOME TO SOFTLINE AMUL BILLING",
                               font="digital")
    ...
    if sh == 1:
        ...
        while row < 33:
            sh1_list.append(
                [count, sh1.cell(row, 2).value,
                 sh1.cell(row, 3).value])
            row += 1
            count += 1
        ...
        while count < 30:
            ...
            while count2 < len(rate):
                print('[' + str(count2 + 1) + '] ' + str(rate[count2][0]) +
                      ' (' + str(rate[count2][1]) + ') - ' +
                      str(rate[count2][2]) + Color.END)
                count2 += 1
            ...
            while count3 == 0:
                ...
                if order == 9:
                    kool_plastic = float(
                        input(
                            'Enter no. of Amul Kool (Plastic) - 200ml X 30: \n'
                        ))
                ...
                if order == 13:
                    lp180 = float(
                        input('Enter no. of Lassi(Packet) - 180ml: \n'))
                ...
                skip = input('More Orders from ' + sh1_list[ans4][1] +
                             '? [Y/N]')
                if (skip.upper() == "Y") or (skip == "1"):
                    ...
                    if sh1.cell(row1, 4) != 0:
                        ...
                        cost_of_order = g500 * rate[0][2] + g1000 * rate[1][
                            2] + s500 * rate[2][2] + s1000 * rate[3][
                                2] + c500 * rate[4][2] + c1000 * rate[5][
                                    2] + t500 * rate[6][2] + t1000 * rate[7][
                                        2] + kool_plastic * rate[8][
                                            2] + d200 * rate[9][2] + d400 * rate[
                                                10][2] + d1000 * rate[11][
                                                    2] + lp180 * rate[12][
                                                        2] + p200 * rate[13][
                                                            2] + p1000 * rate[
    ...
    if sh == 2:
        ...
        while row < 33:
            sh2_list.append(
                [count, sh2.cell(row, 2).value,
                 sh2.cell(row, 3).value])
            row += 1
            count += 1
        ...
        while count < 30:
            ...
            while count3 == 0:
                ...
                skip = input('More Orders from ' + sh2_list[ans4][1] +
                             '? [Y/N]')
                if (skip.upper() == "Y") or (skip == "1"):
                    count3 = 0
                else:
    ...
    if sh == 3:
        ...
        while row < 33:
            sh3_list.append(
                [count, sh3.cell(row, 2).value,
                 sh3.cell(row, 3).value])
            row += 1
            count += 1
        ...
        while count < 30:
            ...
            while count3 == 0:
                ...
                skip = input('More Orders from ' + sh3_list[ans4][1] +
                             '? [Y/N]')
                if (skip.upper() == "Y") or (skip == "1"):
                    count3 = 0
                else:
    ...
    if sh == 4:
        ...
        while row < 33:
            sh4_list.append(
                [count, sh4.cell(row, 2).value,
                 sh4.cell(row, 3).value])
            row += 1
            count += 1
        ...
        while count < 30:
            ...
            while count3 == 0:
                ...
                skip = input('More Orders from ' + sh4_list[ans4][1] +
                             '? [Y/N]')
                if (skip.upper() == "Y") or (skip == "1"):
                    count3 = 0
                else:
